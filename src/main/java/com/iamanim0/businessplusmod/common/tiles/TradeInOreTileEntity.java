...
public class TradeInOreTileEntity  extends TileEntity implements ITickableTileEntity, INamedContainerProvider {
	
	private static final ResourceLocation ORES_TAG = new ResourceLocation(BusinessPlusMod.MOD_ID, "tradeinoresitem");
	...
	public TradeInOreTileEntity() {
		// TODO Auto-generated constructor stub
		super(TileEntityTypeInit.TRADEIN_ORE.get());
	...
	public void generateStockContents() {	
        ...
        for(int i=0; i < stockContents.getSizeInventory(); i++) {
        	stockContents.getStackInSlot(i).setDisplayName(new StringTextComponent(stockContents.getStackInSlot(i).getDisplayName().getString() +" - "+ (PriceList.getPriceForItemMINER(stockContents.getStackInSlot(i), 40)/100.00) + "$"));
        }
	}
	...
	public Container createMenu(int windowID, PlayerInventory playerInventory, PlayerEntity player) {
		...
		return new TradeInOreContainer(windowID, playerInventory, stockContents, inputContents, outputContents, this, tradeInStateData);
	}

	@Override
	public ITextComponent getDisplayName() {
		// TODO Auto-generated method stub
		return new TranslationTextComponent("container.tradein_ore");
	}
	...
	public void tick() {
		...
		if(world.isRemote){
	    	...
	    	if(this.inputContents.getStackInSlot(0).getItem().isIn(ItemTags.getCollection().get(ORES_TAG))) {
	    		try {
	    			this.inputContents.inputMoney(this.inputContents.getStackInSlot(0), 40);

...
public class MarketplaceContents implements IInventory {
    ...
    public MarketplaceContents(int size, Predicate<PlayerEntity> canPlayerAccess, Notify notify) {
    ...
    public MarketplaceContents(int size) {
        this.vendingComponentContents = new ItemStackHandler(size);
    }
